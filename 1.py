...
class Registro(Frame):
    ...
    def create_wietgs(self):
        ...
        Label(self.frame2, text = 'edad',fg='white', bg ='navy', font=('Rockwell',13,'bold')).grid(column=0,row=3, pady=15)
        Label(self.frame2, text = 'email', fg='white',bg ='navy', font=('Rockwell',13,'bold')).grid(column=0,row=4, pady=15)
        Label(self.frame2, text = 'naci',fg='white', bg ='navy', font=('Rockwell',13,'bold')).grid(column=0,row=5, pady=15)
        ...
        Entry(self.frame2,textvariable=self.edad , font=('Arial',12)).grid(column=1,row=3)
        Entry(self.frame2,textvariable=self.email , font=('Arial',12)).grid(column=1,row=4)
        Entry(self.frame2,textvariable=self.naci , font=('Arial',12)).grid(column=1,row=5)
        ...
        self.tabla['columns'] = ('Nombre', 'edad', 'email', 'naci')
        ...
        self.tabla.column('naci', minwidth=100, width=105, anchor='center')
        ...
        self.tabla.heading('naci', text='naci', anchor ='center')
    ...
    def agregar_datos(self):
        ...
        if codigo and nombre and edad and email and naci !='':        
            self.tabla.insert('',0, text = codigo, values=datos)
            self.base_datos.inserta_producto(codigo, nombre, edad, email, naci)
    ...
    def obtener_fila(self, event):
        ...
        self.nombre_borar = data['values'][1]
